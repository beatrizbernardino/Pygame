...
class player(pygame.sprite.Sprite):
    def __init__(self,x,y,width,height):
        ...
        self.images = []
        self.images.append(pygame.image.load('R1.png').convert())
        self.images.append(pygame.image.load('R2.png').convert())
        self.images.append(pygame.image.load('R3.png').convert())
        self.images.append(pygame.image.load('R4.png').convert())
        self.images.append(pygame.image.load('R5.png').convert())
        self.images.append(pygame.image.load('R6.png').convert())
        self.images.append(pygame.image.load('R7.png').convert())
        self.images.append(pygame.image.load('R8.png').convert())
        self.images.append(pygame.image.load('R9.png').convert())
        self.index=0
...
#               self.image=(walkRight[self.walkCount//3], (self.x,self.y))
  ...
  #     else:
   #       if self.right:
  #            self.image=(walkRight[0], (self.x,self.y))
#           else:
#               self.image=(walkLeft[0], (self.x,self.y))
...
#    hits = pygame.sprite.groupcollide(player, Platform, False, )
#    for hit in hits:
#      print("bateu")
